...
We claim the only solution is $f(x)\equiv x$, which obviously works. We now show it is the only solution.
***

It is easy to check that the only linear function is $f(x)=x$.
